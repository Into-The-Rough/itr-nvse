...
DEFINE_COMMAND_PLUGIN(SetHairColorAlt, "Set NPC hair colour from r,g,b (0-255 each)", 1, 4, kParams_SetHairColorAlt);
DEFINE_COMMAND_PLUGIN(GetHairColorAlt, "Get NPC hair colour, channel 1=R 2=G 3=B, else packed", 1, 2, kParams_GetHairColorAlt);
