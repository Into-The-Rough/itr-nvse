...
void RegisterEvents()
{
	...
	//path, flags, sourceSound, hasPos, x, y, z, volume
	static P soundPosParams[] = { P::eParamType_String, P::eParamType_Int, P::eParamType_AnyForm, P::eParamType_Int,
		P::eParamType_Float, P::eParamType_Float, P::eParamType_Float, P::eParamType_Float };
	g_eventManagerInterface->RegisterEvent("ITR:OnSoundPlayedByPosition", 8, soundPosParams, F::kFlag_FlushOnLoad);
